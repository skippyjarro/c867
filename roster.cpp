...
void Roster::parse(string row) {
    ...
    this->add(newStudentID, newStudentFirstName, newStudentLastName, newStudentEmailAddress, newStudentAge, newDaysInCourse1, newDaysInCourse2, newDaysInCourse3, newDegreeProgram);
}
